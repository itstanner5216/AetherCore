...
class DefenseAgent:
    ...
    def _analyze_importers(self, file_path: str) -> List[DefenseEvidence]:
        ...
        if importers:
            evidence.append(DefenseEvidence(
    ...
    def _analyze_config_role(self, file_path: str) -> List[DefenseEvidence]:
        ...
        config_indicators = [
            'config', 'settings', 'env', 'rc', 'options',
            'package.json', 'tsconfig', 'webpack', 'babel',
            'docker', 'yaml', 'yml', 'toml', 'ini'
        ]
    ...
    def _analyze_entry_point(self, file_path: str) -> List[DefenseEvidence]:
        ...
        entry_indicators = [
            'main', 'index', 'app', 'server', 'entry',
            '__init__', '__main__', 'cli', 'run'
        ]
    ...
    def _analyze_content_quality(self, file_path: str) -> List[DefenseEvidence]:
        ...
        func_count = len(re.findall(r'^(def|function|async\s+function)\s+\w+', content, re.MULTILINE))
    ...
    def _calculate_verdict(self, evidence: List[DefenseEvidence]) -> Tuple[str, float]:
        ...
        critical_categories = {
            'IMPORT_DEPENDENCY', 'ENTRY_POINT_DEPENDENCY', 'ENTRY_POINT',
            'README', 'CONFIGURATION_FILE', 'TEST_FILE'
        }
    ...
    def _build_defense_argument(self, file_path: str, evidence: List[DefenseEvidence], verdict: str) -> str:
        ...
        if verdict == "ESSENTIAL":
            ...
            argument_parts.append("📋 **This file has some value but limited evidence of active use.**\n")
