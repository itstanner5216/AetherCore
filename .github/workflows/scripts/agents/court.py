...
class FileCourt:
    ...
    def generate_full_report(self) -> str:
        ...
        if verdicts["KEEP"]:
            ...
            kept_trials.sort(
                key=lambda t: t.verdict.get("reasoning", {}).get("defense_weight", 0), reverse=True
            )
...
def main():
    ...
    # Initialize court
    court = FileCourt(repo_root=args.repo_root, conservative=conservative, verbose=verbose)
