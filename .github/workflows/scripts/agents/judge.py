...
class JudgeAgent:
    ...
    def _identify_key_factors(self, prosecution: dict, defense: dict) -> list[str]:
        ...
        if pros_evidence:
            factors.append(
                f"🔴 Prosecution: {pros_evidence[0].get('description', 'N/A')}"
            )
    ...
    def _assess_risk(
        ...
        if defense.get("import_chain"):
            risks.append(
                f"MEDIUM: {len(defense['import_chain'])} files may be affected"
            )
...
if __name__ == "__main__":
    ...
    mock_prosecution = {
        ...
        "evidence": [
            ...
            {
                "category": "STALE",
                "description": "Not modified in 200 days",
                "strength": 0.6,
            },
        ],
        "staleness_days": 200,
        ...
        "evidence": [
            {
                ...
                "description": "File has 150 lines",
                "strength": 0.5,
            }
        ],
        "import_chain": [],
