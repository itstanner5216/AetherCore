...
class SourceValidator {
  scoreSource(urlStr, domain = "", contentType = "article") {
    ...
    for (const [knownDomain, knownScore] of Object.entries(
      DOMAIN_CREDIBILITY
    )) {
...
module.exports = {
  score_source: (params) =>
    validator.scoreSource(params.url, params.domain, params.content_type),
  cross_reference: (params) =>
    validator.crossReference(params.claim, params.sources),
  detect_bias: (params) =>
    validator.detectBias(params.content, params.source_url),
